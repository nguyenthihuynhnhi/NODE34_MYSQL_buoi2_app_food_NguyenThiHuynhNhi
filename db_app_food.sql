...
--
-- Database: app_food
-- Generation Time: 2023-10-05 00:56:34.9020
-- -------------------------------------------------------------
...
INSERT INTO `users` (`user_id`, `full_name`, `email`, `passwords`) VALUES
(1, 'Alessandro Klammt', 'aklammt0@ucla.edu', 'hD1>sQvrhJt$c'),
(2, 'Sharai Errey', 'serrey1@weibo.com', 'oE9=!N~9'),
(3, 'Nikolas MacNeish', 'nmacneish2@oracle.com', 'iA0?JllG'),
(4, 'Lauren Tiner', 'ltiner3@1688.com', 'jN9c7B?pcrW}'),
(5, 'Kessia Bedbrough', 'kbedbrough4@utexas.edu', 'bM9%$P(/g_>I_'),
(6, 'Carmina Bolding', 'cbolding5@answers.com', 'uN8\"k7HghNDi3t|a'),
(7, 'Art Poe', 'apoe6@shutterfly.com', 'sO7,2rg*?\"(a.4'),
(8, 'Rea Beebe', 'rbeebe7@prlog.org', 'dW8@EB*e'),
(9, 'Valentin Leadston', 'vleadston8@theguardian.com', 'gA2*CA_yD3'),
(10, 'Avictor Ricioppo', 'aricioppo9@census.gov', 'bV1#FzbprP>,cR'),
(11, 'Marve Brandenberg', 'mbrandenberga@ft.com', 'eM0)!Bvn5J(7'),
(12, 'Tammi Abelov', 'tabelovb@merriam-webster.com', 'qO7.a.{KSccM3'),
(13, 'Aldridge Gabbitus', 'agabbitusc@ucoz.ru', 'qK7@bp1ECg'),
(14, 'Sergio Roycroft', 'sroycroftd@census.gov', 'qI9%fH?!'),
(15, 'Lila Goulder', 'lgouldere@mail.ru', 'gT6=Px&KgER.qTk@'),
(16, 'Helyn Chapellow', 'hchapellowf@edublogs.org', 'lM3$*\'R<teMPT!'),
(17, 'Fenelia Eakin', 'feaking@dion.ne.jp', 'xA9#*s)\"'),
(18, 'Cordell Lorenzini', 'clorenzinih@spiegel.de', 'tB7~{6)O=HQpa,'),
(19, 'Del Lebbern', 'dlebberni@imdb.com', 'qM7$xn1Ry'),
(20, 'Basilius Healing', 'bhealingj@msn.com', 'qQ2$Obo#J4');
